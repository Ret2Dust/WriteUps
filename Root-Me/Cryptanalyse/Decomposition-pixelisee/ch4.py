...
if __name__ == "__main__":
    # calcul the size of the image based on the fist row
    image_size = 0
    data_0 = data[1].split("+")
    for column_0 in data_0:
        column_0 = column_0.split("x")
        image_size += int(column_0[1])
    ...
    output = Image.new("RGB", (image_size, len(data)), "Blue")
